...
1. **构建镜像**
```bash
docker build -t medivisual-artist-- .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name medivisual-artist-- medivisual-artist--
```
...
- **问题反馈**: https://github.com/MoKangMedical/medivisual-artist--/issues
